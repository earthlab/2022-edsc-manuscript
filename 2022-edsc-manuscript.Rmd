...
# data science communication post by year
...
#### _**Data Science Practices**_
```{r t testing - science practices, echo=FALSE, tidy=TRUE}
t.test(confpost$Ability, confpre$Ability)
cohensD(confpost$Ability, confpre$Ability)
```

```{r, echo=FALSE, include=FALSE}
# data science practices (pre) by year
...
# data science practices (post) by year
...
#### _**Science Identity**_
```{r t testing - science identity, echo=FALSE, tidy=TRUE}
t.test(idpost$Ability, idpre$Ability)
cohensD(idpost$Ability, idpre$Ability)
```

```{r t testing - science identity by year, echo=FALSE, include=FALSE}
...
#### _**Data Science Skills**_
```{r t testing - python skills, echo=FALSE, tidy=TRUE}
t.test(techconfpost$Ability, techconfpre$Ability)
cohensD(techconfpost$Ability, techconfpre$Ability)
```


```{r t testing - data science skills by year, echo=FALSE, include=FALSE}
### Data Science Skills by year (pre)
...
# Data science skills (post) by year
...
#### _**Python Skills**_
```{r t testing - data science skills, echo=FALSE, tidy=TRUE}
t.test(techcomfortpost$Ability, techcomfortpre$Ability)
cohensD(techcomfortpost$Ability, techcomfortpre$Ability)
```


```{r t testing - python skills by year, echo=FALSE, include=FALSE}
#### Python Skills (pre) by Year
...
# t-testing python skills by year
# Year 1
...
```{r ability growth boxplots, echo=FALSE, fig.width=8, fig.height=4}
p <- ggplot(abil_trial_dimension_all6, aes(x=Dimension, y=Ability)) + 
  geom_boxplot() +
  ggtitle("Change in Ability by Dimension & Trial (Before/After)") +
