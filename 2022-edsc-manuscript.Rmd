---
title: "edsc-manuscript"
output: html_document
date: '2022-11-24'
---

```{r read data & install libraries, fig.width = 4, fig.asp = .99, results='markup', echo=FALSE, warning = FALSE, message = FALSE, tidy=TRUE}
...
```{r build comfort Wright Maps tech, fig.width = 4.7, results='markup', echo=FALSE, warning = FALSE, message = FALSE, tidy=TRUE}
...
```{r build confidence Wright Maps tech, fig.width = 4.7, results='markup', echo=FALSE, warning = FALSE, message = FALSE, tidy=TRUE}
wrightmappreconf <- wrightMap(abilpreconf, thresholdspostconf, item.side = itemClassic,
                        dim.names = "",
...
```{r build comfort Wright Maps, fig.width = 4.7, results='markup', echo=FALSE, warning = FALSE, message = FALSE, tidy=TRUE}
...
```{r build confidence Wright Maps, fig.width = 4.7, results='markup', echo=FALSE, warning = FALSE, message = FALSE, tidy=TRUE}
...
```{r build science identity Wright Maps, fig.width = 4.7, results='markup', echo=FALSE, warning = FALSE, message = FALSE, tidy=TRUE}
